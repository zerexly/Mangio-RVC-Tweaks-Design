        ...
        with gr.Tabs():
            with gr.TabItem(i18n("模型推理")):
                with gr.Row():
                    ...
                    refresh_button = gr.Button(i18n("Refresh Files"), variant="secondary")
                ...
                with gr.TabItem("Single"):
                    ...
                    with gr.Column(visible=False) as advanced_settings: # Initially hidden
                        with gr.Row(label = "Advanced Settings", open = False):
                            ...
                            with gr.Column():
                                ...
                                frmntbut = gr.Button("Apply", variant="secondary", visible=bool(DoFormant))
                    ...
                    but0 = gr.Button(i18n("转换"), variant="secondary").style(full_width=True)
            ...
            with gr.TabItem(i18n("训练")):
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        ...
                        but3 = gr.Button(i18n("训练模型"), variant="secondary", visible=True)
