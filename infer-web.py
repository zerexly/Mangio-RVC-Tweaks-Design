...
def GradioSetup(UTheme=gr.themes.Soft()):
    ...
    )  # Set the first found weight as the preloaded model

    with gr.Blocks(theme=UTheme, title="Ai Maker") as app:
        gr.HTML("<h1> Ai Voice Maker </h1>")
        # gr.Markdown(
        #     value=i18n(
        ...
        with gr.Tabs():
            with gr.TabItem(i18n("模型推理")):
                with gr.Row():
                    sid0 = gr.Dropdown(
                        label=i18n("推理音色"), choices=sorted(names), value=default_weight
                    )
                    refresh_button = gr.Button(
                        i18n("Refresh Files"), variant="secondary"
                    )
                    clean_button = gr.Button(i18n("卸载音色省显存"), variant="secondary")
                    clean_button.click(
                ...
                with gr.TabItem("Single"):
                    ...
                    with gr.Column(
                        ...
                        with gr.Row(label="Advanced Settings", open=False):
                            ...
                            with gr.Column():
                                ...
                                with gr.Accordion(
                                    label="Custom f0 [Root pitch] File", open=False
                                ):
                                    f0_file = gr.File(
                    ...
                    but0 = gr.Button(i18n("转换"), variant="secondary").style(
                        full_width=True
                    )
                ...
                with gr.TabItem("Batch"):
                        ...
                        with gr.Row():
                            with gr.Column():
                                ...
                                with gr.Row(
                                    ...
                                    with gr.Row(
                                        label="Advanced Settings [Batch]", open=False
                                    ):
                                        with gr.Column():
                                ...
                                but1 = gr.Button(i18n("转换"), variant="secondary")
                                but1.click(
                                    vc_multi,
                                    [
                                        spk_item,
                    ...
                    )  # Set VC parameters for the preloaded model
            ...
            with gr.TabItem(i18n("伴奏人声分离&去混响&去回声")):  # UVR section
                with gr.Group():
                    ...
                    with gr.Row():
                        ...
                        but2 = gr.Button(i18n("转换"), variant="secondary")
            ...
            with gr.TabItem(i18n("训练")):
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        ...
                        but1 = gr.Button(i18n("处理数据"), variant="secondary")
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        ...
                        but2 = gr.Button(i18n("特征提取"), variant="secondary")
                        info2 = gr.Textbox(
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        ...
                        but3 = gr.Button(
                            i18n("训练模型"), variant="secondary", visible=True
                        )
                        but3.click(
                            fn=stoptraining,
            ...
            with gr.TabItem(i18n("ckpt处理")):
                with gr.Group():
                    ...
                    with gr.Row():
                        but6 = gr.Button(i18n("融合"), variant="secondary")
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        but7 = gr.Button(i18n("修改"), variant="secondary")
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        ...
                        but8 = gr.Button(i18n("查看"), variant="secondary")
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        ...
                        but9 = gr.Button(i18n("提取"), variant="secondary")
            ...
            with gr.TabItem(i18n("Onnx导出")):
                ...
                with gr.Row():
                    butOnnx = gr.Button(i18n("导出Onnx模型"), variant="secondary")
